  ...
  return (
    <footer className='relative px-4 py-6 z-20 flex flex-col items-center justify-center bg-secondary text-text text-center pointer-events-auto'>
      <div className='flex flex-col xs:flex-row items-center'>
        Made with
        <div className='mt-2 xs:mt-0 ml-3 flex gap-2 text-[17px] '>
          {techUsed.map((icon) => (
            <div
              key={icon.name}
      ...
      <p className='mt-5 opacity-75 text-[14px] '>
      ...
      <a
              ...
              target='_blank'
              rel='noreferrer'
              className='mt-4 text-[18px] font-medium flex cursor-pointer items-center gap-1 text-text transition-transform duration-200 hover:-translate-y-[2px] hover:text-primary'
            >
              Code
